...
<div class="w-100" id="main">
   ...
   <div class="row mt-80px ">
      <div class="col-md-6">
         <h1 class="events-title">Events<span>24 entries</span></h1>
      </div>
      <div class="col-md-6 text-right">
         <button class="btn-delete text-white">Delete (2 events)</button>
      </div>
   </div>
            ...
            <table id="example" class="table my-tbl-style " style="width:100%">
               <thead>
                  <tr>
                     ...
                     <th class="p_participants">Participants<img class="icon_sorting" src="../assets/imgs/Group-642.png"></th>
                     <th class="p_event_started">Event Started<img class="icon_sorting" src="../assets/imgs/Group-642.png"></th>
                     <th class="p_last_modified">Last Modified<img class="icon_sorting" src="../assets/imgs/Group-642.png"></th>
                     <th class="p_vendor">Author<img class="icon_sorting" src="../assets/imgs/Group-642.png"></th>
                     <th></th>
                  </tr>
               </thead>
               <tbody>
                  <tr class="tbl_gray" id="tbl_gray1">
                     ...
                     <td class="txt_last_modified color-black ">June 13, 2020</td>
                     <td class="txt_vendor color-black ">Danielle Dewitt</td>
                     <td>
                        <p class="custem_doted tbl_gray1 cursor" class="btn  btn_doted_dropdown" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-h" aria-hidden="true"></i></p>
                  ...
                  <tr class="tbl_gray" id="tbl_gray3">
                     ...
                     <td class="txt_last_modified color-black ">April 13, 2020</td>
                     <td class="txt_vendor color-black ">Danielle Dewitt</td>
                     <td class="">
